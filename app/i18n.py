...
T: dict[str, dict[str, str]] = {
    ...
    "res.photo_title": {
        "lv": "Foto augšupielāde ar atpazīšanu",
        "ru": "Загрузка фото с распознаванием",
        "en": "Photo upload with recognition",
    },
    "res.photo_multi": {"lv": "Var pievienot vairākas bildes", "ru": "Можно загрузить несколько фото", "en": "You can upload multiple photos"},
    "res.photo_hint": {
        "lv": "Nofočējiet skaitītāju no telefona vai augšupielādējiet gatavas bildes. Sistēma piedāvās atpazīto rādījumu, pēc tam jūs apstiprināt vai labojat.",
        "ru": "Сфотографируйте счётчик с телефона или загрузите готовые фото. Система предложит распознанное значение, затем вы подтверждаете или исправляете.",
        "en": "Take a meter photo from your phone or upload existing images. The system suggests the recognized value, then you confirm or edit it.",
    },
    "res.photo_pick": {"lv": "Izvēlēties foto", "ru": "Выбрать фото", "en": "Choose photos"},
    "res.photo_recognize": {"lv": "Atpazīt datus", "ru": "Распознать данные", "en": "Recognize data"},
    "res.photo_review_title": {"lv": "Foto atpazīšanas pārbaude", "ru": "Проверка распознавания фото", "en": "Photo recognition review"},
    "res.photo_review_sub": {"lv": "Periods", "ru": "Период", "en": "Period"},
    "res.photo_back": {"lv": "← Atpakaļ uz kabinetu", "ru": "← Назад в кабинет", "en": "← Back to dashboard"},
    "res.photo_confirm": {"lv": "Apstiprināt šo rādījumu", "ru": "Подтвердить это показание", "en": "Confirm this reading"},
    "res.photo_meter": {"lv": "Skaitītājs", "ru": "Счётчик", "en": "Meter"},
    "res.photo_value": {"lv": "Atpazītais rādījums", "ru": "Распознанное показание", "en": "Recognized reading"},
    "res.photo_candidates": {"lv": "Atrasti varianti", "ru": "Найденные варианты", "en": "Detected candidates"},
    "res.photo_review_hint": {
        "lv": "Pirms nosūtīšanas pārbaudiet skaitītāju un vērtību katrai bildei.",
        "ru": "Перед отправкой проверьте счётчик и значение для каждой фотографии.",
        "en": "Before submitting, verify meter and value for each photo.",
    },
    "res.photo_submit": {"lv": "Saglabāt apstiprinātos rādījumus", "ru": "Сохранить подтверждённые показания", "en": "Save confirmed readings"},
    "res.photo_no_meters": {
        "lv": "Jūsu kontam nav aktīvu skaitītāju foto atpazīšanai.",
        "ru": "К вашему аккаунту не привязаны активные счётчики для распознавания фото.",
        "en": "No active meters are linked to your account for photo recognition.",
    },
    "res.photo_no_files": {"lv": "Lūdzu pievienojiet vismaz vienu foto.", "ru": "Пожалуйста, добавьте хотя бы одно фото.", "en": "Please add at least one photo."},
    "res.photo_too_many": {
        "lv": "Vienā reizē drīkst augšupielādēt ne vairāk kā {max_files} foto.",
        "ru": "За один раз можно загрузить не более {max_files} фото.",
        "en": "You can upload at most {max_files} photos at once.",
    },
    "res.photo_not_image": {"lv": "Fails nav attēls.", "ru": "Файл не является изображением.", "en": "File is not an image."},
    "res.photo_too_large": {
        "lv": "Bilde ir pārāk liela (maks. {max_mb} MB).",
        "ru": "Фото слишком большое (макс. {max_mb} МБ).",
        "en": "Image is too large (max {max_mb} MB).",
    },
    "res.photo_missing_data": {
        "lv": "Trūkst skaitītāja vai rādījuma vērtības.",
        "ru": "Не выбран счётчик или не заполнено значение.",
        "en": "Meter or reading value is missing.",
    },
    "res.photo_bad_value": {"lv": "Nederīga rādījuma vērtība.", "ru": "Некорректное значение показания.", "en": "Invalid reading value."},
    "res.photo_meter_forbidden": {
        "lv": "Skaitītājs nav pieejams šim kontam.",
        "ru": "Счётчик недоступен для этого аккаунта.",
        "en": "Meter is not available for this account.",
    },
    "res.photo_meter_missing": {"lv": "Skaitītājs nav atrasts.", "ru": "Счётчик не найден.", "en": "Meter not found."},
    "res.photo_saved": {
        "lv": "Saglabāti {count} rādījumi par periodu {period}.",
        "ru": "Сохранено {count} показаний за период {period}.",
        "en": "Saved {count} readings for period {period}.",
    },
    "res.photo_nothing_confirmed": {
        "lv": "Nav apstiprināts neviens foto rādījums.",
        "ru": "Не подтверждено ни одно фото-показание.",
        "en": "No photo readings were confirmed.",
    },
    ...
    # ------------------------------------------------------------------ #
    # Панель управляющего (mgr.*)
    # ------------------------------------------------------------------ #
    "mgr.panel": {"lv": "pārvaldes panelis", "ru": "панель управляющего",
                  "en": "manager panel"},
    "mgr.period": {"lv": "Periods", "ru": "Период", "en": "Period"},
    "mgr.integration": {"lv": "Integrācija", "ru": "Интеграция", "en": "Integration"},
    "mgr.window_btn": {"lv": "Nodošanas periods", "ru": "Период подачи",
                       "en": "Submission window"},
    "mgr.sync_btn": {"lv": "Sinhronizēt ar Visma Horizon",
                     "ru": "Синхронизировать с Visma Horizon",
                     "en": "Sync with Visma Horizon"},
    "mgr.objects_card": {"lv": "Objekti — mājas, dzīvokļi, skaitītāji",
                         "ru": "Объекты — дома, квартиры, счётчики",
                         "en": "Objects — buildings, units, meters"},
    "mgr.objects_card_desc": {
        "lv": "Izveidojiet struktūru, lai iedzīvotāji varētu reģistrēties un nodot rādījumus",
        "ru": "Создайте структуру, чтобы жители могли регистрироваться и подавать показания",
        "en": "Set up the structure so residents can register and submit readings",
    },
    "mgr.stat_progress": {"lv": "Nodošanas gaita", "ru": "Ход подачи",
                          "en": "Submission progress"},
    "mgr.stat_submitted": {"lv": "Nodoti / skaitītāji", "ru": "Подано / счётчики",
                           "en": "Submitted / meters"},
    "mgr.stat_pending": {"lv": "Vēl nav nodoti", "ru": "Ещё не поданы",
                         "en": "Not submitted yet"},
    "mgr.stat_anomalies": {"lv": "Anomālijas", "ru": "Аномалии", "en": "Anomalies"},
    "mgr.meters_status": {"lv": "Skaitītāju statuss", "ru": "Статус счётчиков",
                          "en": "Meter status"},
    "mgr.col_unit": {"lv": "Dzīvoklis", "ru": "Квартира", "en": "Unit"},
    "mgr.col_type": {"lv": "Tips", "ru": "Тип", "en": "Type"},
    "mgr.col_meter": {"lv": "Skaitītājs", "ru": "Счётчик", "en": "Meter"},
    "mgr.col_reading": {"lv": "Rādījums", "ru": "Показание", "en": "Reading"},
    "mgr.col_consumption": {"lv": "Patēriņš", "ru": "Расход", "en": "Consumption"},
    "mgr.col_status": {"lv": "Statuss", "ru": "Статус", "en": "Status"},
    "mgr.st_waiting": {"lv": "Gaida", "ru": "Ожидает", "en": "Waiting"},
    "mgr.st_anomaly": {"lv": "Anomālija", "ru": "Аномалия", "en": "Anomaly"},
    "mgr.st_synced": {"lv": "Sinhronizēts", "ru": "Синхронизировано", "en": "Synced"},
    "mgr.st_submitted": {"lv": "Nodots", "ru": "Подано", "en": "Submitted"},
    "mgr.integ_log": {"lv": "Integrācijas žurnāls", "ru": "Журнал интеграции",
                      "en": "Integration log"},
    "mgr.no_sync": {"lv": "Vēl nav sinhronizāciju.", "ru": "Синхронизаций пока нет.",
                    "en": "No synchronizations yet."},
    # Объекты (список домов)
    "mgr.objects": {"lv": "Objekti", "ru": "Объекты", "en": "Objects"},
    "mgr.objects_h": {"lv": "Objekti (mājas)", "ru": "Объекты (дома)",
                      "en": "Objects (buildings)"},
    "mgr.objects_hint": {
        "lv": "Izveidojiet mājas, dzīvokļus un skaitītājus, lai iedzīvotāji varētu nodot rādījumus.",
        "ru": "Создайте дома, квартиры и счётчики, чтобы жители могли подавать показания.",
        "en": "Create buildings, units and meters so residents can submit readings.",
    },
    "mgr.add_building": {"lv": "Pievienot māju", "ru": "Добавить дом",
                         "en": "Add building"},
    "mgr.address": {"lv": "Adrese", "ru": "Адрес", "en": "Address"},
    "mgr.name": {"lv": "Nosaukums", "ru": "Название", "en": "Name"},
    "mgr.ext_id": {"lv": "Ārējais ID (Visma)", "ru": "Внешний ID (Visma)",
                   "en": "External ID (Visma)"},
    "mgr.add": {"lv": "Pievienot", "ru": "Добавить", "en": "Add"},
    "mgr.houses": {"lv": "Mājas", "ru": "Дома", "en": "Buildings"},
    "mgr.no_buildings": {"lv": "Vēl nav māju. Pievienojiet pirmo pa kreisi.",
                         "ru": "Домов пока нет. Добавьте первый слева.",
                         "en": "No buildings yet. Add the first one on the left."},
    "mgr.units_suffix": {"lv": "dzīvokļi", "ru": "квартир", "en": "units"},
    # Дом (квартиры + генерация)
    "mgr.add_unit": {"lv": "Pievienot dzīvokli", "ru": "Добавить квартиру",
                     "en": "Add unit"},
    "mgr.unit_no": {"lv": "Dzīvokļa Nr.", "ru": "№ квартиры", "en": "Unit no."},
    "mgr.account_number": {"lv": "Konta numurs", "ru": "Номер счёта",
                           "en": "Account number"},
    "mgr.account_hint": {"lv": "Ar šo numuru iedzīvotājs reģistrējas.",
                         "ru": "По этому номеру житель регистрируется.",
                         "en": "Residents register using this number."},
    "mgr.area": {"lv": "Platība m²", "ru": "Площадь м²", "en": "Area m²"},
    "mgr.generate_units": {"lv": "Ģenerēt dzīvokļus", "ru": "Сгенерировать квартиры",
                           "en": "Generate units"},
    "mgr.generate_hint": {
        "lv": "Piem. 119. sērija: 2 kāpņutelpas × 10 stāvi × 4 dzīvokļi = 80.",
        "ru": "Напр. 119 серия: 2 подъезда × 10 этажей × 4 квартиры = 80.",
        "en": "E.g. series 119: 2 entrances × 10 floors × 4 units = 80.",
    },
    "mgr.entrances": {"lv": "Kāpņutelpas", "ru": "Подъезды", "en": "Entrances"},
    "mgr.floors": {"lv": "Stāvi", "ru": "Этажи", "en": "Floors"},
    "mgr.per_floor": {"lv": "Dz./stāvā", "ru": "Кв./этаж", "en": "Units/floor"},
    "mgr.start_from": {"lv": "Sākt no Nr.", "ru": "Начать с №", "en": "Start from no."},
    "mgr.users_per_unit": {"lv": "Lietotāji/dz.", "ru": "Польз./кв.",
                           "en": "Users/unit"},
    "mgr.account_prefix": {"lv": "Konta prefikss", "ru": "Префикс счёта",
                           "en": "Account prefix"},
    "mgr.units_count": {"lv": "Dzīvokļi", "ru": "Квартиры", "en": "Units"},
    "mgr.no_units": {"lv": "Vēl nav dzīvokļu.", "ru": "Квартир пока нет.",
                     "en": "No units yet."},
    "mgr.meters_suffix": {"lv": "skaitītāji", "ru": "счётчиков", "en": "meters"},
    # Квартира (счётчики)
    "mgr.add_meter": {"lv": "Pievienot skaitītāju", "ru": "Добавить счётчик",
                      "en": "Add meter"},
    "mgr.meter_no": {"lv": "Skaitītāja Nr.", "ru": "№ счётчика", "en": "Meter no."},
    "mgr.location": {"lv": "Atrašanās vieta", "ru": "Расположение", "en": "Location"},
    "mgr.initial_reading": {"lv": "Sākuma rādījums", "ru": "Начальное показание",
                            "en": "Initial reading"},
    "mgr.meters_count": {"lv": "Skaitītāji", "ru": "Счётчики", "en": "Meters"},
    "mgr.no_meters": {"lv": "Vēl nav skaitītāju.", "ru": "Счётчиков пока нет.",
                      "en": "No meters yet."},
    "mgr.account": {"lv": "Konts", "ru": "Счёт", "en": "Account"},
    "mgr.initial_short": {"lv": "sākums", "ru": "начало", "en": "start"},
    # Настройки окна
    "mgr.settings": {"lv": "Iestatījumi", "ru": "Настройки", "en": "Settings"},
    "mgr.window_settings_h": {"lv": "Nodošanas perioda iestatījumi",
                              "ru": "Настройки периода подачи",
                              "en": "Submission window settings"},
    "mgr.window_settings_desc": {
        "lv": "Norādiet, kurās mēneša dienās iedzīvotāji var nodot rādījumus. Periods var šķērsot mēneša robežu (piem. no 25. līdz 5.).",
        "ru": "Укажите, в какие дни месяца жители могут подавать показания. Период может переходить через границу месяца (напр. с 25 по 5).",
        "en": "Set which days of the month residents can submit readings. The window may cross a month boundary (e.g. 25th to 5th).",
    },
    "mgr.day_from": {"lv": "No dienas", "ru": "С дня", "en": "From day"},
    "mgr.day_to": {"lv": "Līdz dienai", "ru": "По день", "en": "To day"},
    "mgr.day_hint": {"lv": "Diena no 1 līdz 28 (lai eksistētu jebkurā mēnesī).",
                     "ru": "День от 1 до 28 (чтобы существовал в любом месяце).",
                     "en": "Day from 1 to 28 (so it exists in any month)."},
    "mgr.save": {"lv": "Saglabāt", "ru": "Сохранить", "en": "Save"},
    "mgr.current_status": {"lv": "Pašreizējais statuss", "ru": "Текущий статус",
                           "en": "Current status"},
    "mgr.window_open_status": {"lv": "Nodošana atvērta", "ru": "Приём открыт",
                               "en": "Submission open"},
    "mgr.window_closed_status": {"lv": "Ārpus perioda", "ru": "Вне периода",
                                 "en": "Outside the window"},
    "mgr.will_close": {"lv": "Aizvērsies", "ru": "Закроется", "en": "Closes"},
    "mgr.will_open": {"lv": "Atvērsies", "ru": "Откроется", "en": "Opens"},
    "mgr.period_label": {"lv": "Periods", "ru": "Период", "en": "Window"},
    "mgr.date_col": {"lv": "datums", "ru": "число", "en": "date"},

    # ------------------------------------------------------------------ #
    # Администрирование (adm.*)
    # ------------------------------------------------------------------ #
    "adm.title": {"lv": "Platformas administrācija", "ru": "Администрирование платформы",
                  "en": "Platform administration"},
    "adm.console": {"lv": "Moderatora konsole", "ru": "Консоль модератора",
                    "en": "Moderator console"},
    "adm.console_desc": {"lv": "Nosūtīt norādījumus aģentam vietnes pārstrādei",
                         "ru": "Отправить указания агенту по доработке сайта",
                         "en": "Send instructions to the agent to improve the site"},
    "adm.orgs": {"lv": "Organizācijas (nomnieki)", "ru": "Организации (арендаторы)",
                 "en": "Organizations (tenants)"},
    "adm.kind": {"lv": "Veids", "ru": "Тип", "en": "Kind"},
    "adm.houses": {"lv": "Mājas", "ru": "Дома", "en": "Buildings"},
    "adm.available": {"lv": "Pieejama", "ru": "Доступна", "en": "Available"},
    "adm.not_available": {"lv": "Nav pieejama", "ru": "Недоступна", "en": "Not available"},
    "adm.configured_hidden": {"lv": "Konfigurēts (paslēpts)", "ru": "Настроено (скрыто)",
                              "en": "Configured (hidden)"},
    "adm.types_catalog": {"lv": "Skaitītāju tipu katalogs", "ru": "Каталог типов счётчиков",
                          "en": "Meter type catalog"},
    "adm.active": {"lv": "Aktīvs", "ru": "Активен", "en": "Active"},
    "adm.inactive": {"lv": "Neaktīvs", "ru": "Неактивен", "en": "Inactive"},
    "adm.add_type": {"lv": "Pievienot skaitītāja tipu", "ru": "Добавить тип счётчика",
                     "en": "Add meter type"},
    "adm.add_type_hint": {"lv": "Jauns tips bez koda izmaiņām — demonstrē paplašināmību.",
                          "ru": "Новый тип без изменения кода — демонстрирует расширяемость.",
                          "en": "A new type without code changes — shows extensibility."},
    "adm.unit_field": {"lv": "Vienība", "ru": "Единица", "en": "Unit"},
    "adm.icon_field": {"lv": "Ikona", "ru": "Иконка", "en": "Icon"},
    "adm.digits": {"lv": "Zīmes", "ru": "Знаки", "en": "Digits"},
    "adm.color": {"lv": "Krāsa", "ru": "Цвет", "en": "Color"},
    "adm.category": {"lv": "Kategorija", "ru": "Категория", "en": "Category"},
    "adm.anomaly_threshold": {"lv": "Anomālijas slieksnis", "ru": "Порог аномалии",
                              "en": "Anomaly threshold"},
    "adm.add_type_btn": {"lv": "Pievienot tipu", "ru": "Добавить тип", "en": "Add type"},
    "adm.digits_suffix": {"lv": "zīmes", "ru": "знаков", "en": "digits"},
    "adm.open_api": {"lv": "Atvērtais API", "ru": "Открытый API", "en": "Open API"},

    # ------------------------------------------------------------------ #
    # eIDAS
    # ------------------------------------------------------------------ #
    "eidas.title": {"lv": "Ienākt ar eIDAS", "ru": "Вход через eIDAS",
                    "en": "Sign in with eIDAS"},
    "eidas.subtitle": {"lv": "Banka / Smart-ID / eParaksts",
                       "ru": "Банк / Smart-ID / eParaksts",
                       "en": "Bank / Smart-ID / eParaksts"},
    "eidas.person_code": {"lv": "Personas kods / identifikators",
                          "ru": "Персональный код / идентификатор",
                          "en": "Personal code / identifier"},
    "eidas.continue": {"lv": "Turpināt", "ru": "Продолжить", "en": "Continue"},
    "eidas.back_to_password": {"lv": "← Ienākt ar e-pastu un paroli",
                               "ru": "← Войти по e-mail и паролю",
                               "en": "← Sign in with e-mail and password"},

    # ------------------------------------------------------------------ #
    # Подтверждение e-mail / OAuth-завершение
    # ------------------------------------------------------------------ #
    "verify.sent_title": {"lv": "Pārbaudiet savu e-pastu", "ru": "Проверьте свою почту",
                          "en": "Check your e-mail"},
    "verify.sent_desc": {
        "lv": "Nosūtījām apstiprinājuma saiti uz jūsu e-pastu. Atveriet to, lai aktivizētu kontu un pieteiktos.",
        "ru": "Мы отправили ссылку для подтверждения на вашу почту. Откройте её, чтобы активировать аккаунт и войти.",
        "en": "We sent a confirmation link to your e-mail. Open it to activate your account and sign in.",
    },
    "verify.demo_mode": {
        "lv": "Demo režīms (e-pasts nav konfigurēts): apstipriniet tieši šeit —",
        "ru": "Демо-режим (почта не настроена): подтвердите прямо здесь —",
        "en": "Demo mode (e-mail not configured): confirm right here —",
    },
    "verify.resend_link": {"lv": "Nesaņēmāt vēstuli? Nosūtīt vēlreiz",
                           "ru": "Не получили письмо? Отправить снова",
                           "en": "Didn't get the e-mail? Resend"},
    "verify.resend_title": {"lv": "Nosūtīt apstiprinājumu vēlreiz",
                            "ru": "Отправить подтверждение снова",
                            "en": "Resend confirmation"},
    "verify.resend_desc": {
        "lv": "Ievadiet e-pastu — ja konts eksistē un nav apstiprināts, nosūtīsim jaunu saiti.",
        "ru": "Введите e-mail — если аккаунт существует и не подтверждён, отправим новую ссылку.",
        "en": "Enter your e-mail — if the account exists and is unconfirmed, we'll send a new link.",
    },
    "verify.send_link": {"lv": "Nosūtīt saiti", "ru": "Отправить ссылку",
                         "en": "Send link"},
    "oauth.complete_title": {"lv": "Pabeigt reģistrāciju", "ru": "Завершить регистрацию",
                             "en": "Complete registration"},
    "oauth.success_with": {"lv": "Pieteikšanās veiksmīga", "ru": "Вход выполнен",
                           "en": "Signed in"},
    "oauth.provide_account": {
        "lv": "Norādiet dzīvokļa konta numuru, lai pabeigtu reģistrāciju.",
        "ru": "Укажите номер лицевого счёта квартиры, чтобы завершить регистрацию.",
        "en": "Provide the unit account number to complete registration.",
    },
}
